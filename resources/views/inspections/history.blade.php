    ...
    <form action="{{ route('inspections.history') }}" method="GET">
        <div class="row g-3 align-items-end">
            ...
            <div class="col-md-3 d-flex gap-2">
                <button type="submit" class="btn btn-primary btn-sm flex-grow-1 fw-700" style="border-radius:8px;font-size:0.82rem;">
                    <span class="material-symbols-outlined align-middle" style="font-size:0.9rem;">filter_list</span> Filter
                </button>
                <a href="{{ route('inspections.history') }}" class="btn btn-sm btn-light border flex-grow-1 fw-600" style="border-radius:8px;font-size:0.82rem;">
                    Reset
                </a>
            </div>
        </div>
