                            ...
                            <div class="p-3 rounded-3 border position-relative bg-adm-border">
                                <div>
                                    <div class="d-flex align-items-center gap-2 mb-2 flex-wrap">
                                        ...
                                        @if($task->laporan_id)
                                            <span class="badge bg-info text-white fw-bold">Dari Laporan</span>
                                        @endif
                                    </div>
                                ...
                                <div class="mt-3 pt-3 border-top border-adm-color">
                                        ...
                                        <div>
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    <div class="d-flex flex-column flex-sm-row align-items-stretch align-items-sm-center gap-2">
                                                        <div class="d-flex align-items-center gap-2 flex-shrink-0">
                                                            ...
                                                            <div>
                                                                <h6 class="mb-0 fs-7">Ketersediaan Air</h6>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    <div class="d-flex flex-column flex-sm-row align-items-stretch align-items-sm-center gap-2">
                                                        <div class="d-flex align-items-center gap-2 flex-shrink-0">
                                                            ...
                                                            <div>
                                                                <h6 class="mb-0 fs-7">Ketersediaan Sabun</h6>
                                                            </div>
                                                        </div>
                                                        <div class="btn-group ms-auto">
                                            ...
                                            <div class="d-flex align-items-center gap-3 mb-3 flex-wrap">
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h6 class="mb-0 fs-7">Bau Tidak Sedap Terdeteksi?</h6>
                                                    </div>
                                                </div>
