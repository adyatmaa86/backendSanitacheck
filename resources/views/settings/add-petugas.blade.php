            ...
            <form action="{{ route('settings.store-petugas') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-text fw-600" style="background:var(--adm-bg);color:var(--adm-muted);padding:10px 12px;border:1.5px solid var(--adm-border);">(Petugas)</span>
                    </div>
                    @error('name')
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-sm btn-primary px-4 fw-700" style="border-radius:8px;">Tambah Petugas</button>
                </div>
            </form>
        </div>
    </div>
